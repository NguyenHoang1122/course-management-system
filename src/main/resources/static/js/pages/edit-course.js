    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateInstructorPreview() {
            ...
            previewInstructor.textContent = (selectedOption && selectedOption.value) ? selectedOption.text : 'Chưa chọn giảng viên';
        }
        ...
        instructorSelect.addEventListener('change', updateInstructorPreview);
